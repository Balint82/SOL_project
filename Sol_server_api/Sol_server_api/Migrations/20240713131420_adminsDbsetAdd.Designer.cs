...
namespace Sol_server_api.Migrations
{
    ...
    [Migration("20240713131420_adminsDbsetAdd")]
    partial class adminsDbsetAdd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sol_server_api.Entities.Admin", b =>
                {
                    ...
                    b.Property<string>("PersonalDataTelNumber")
                    ...
                    b.HasIndex("PersonalDataTelNumber");
                    ...
                    b.HasData(
                        new
                        {
                            AdminID = 1,
                            AdminName = "admin",
                            Password = "$2a$11$mYVhT4OZeXMZGr9HjPM6F.eFC.QvoYbT3tiNiQTyZ4Pye0.E5XKVa",
                            RoleID = 4
                        });
                });
            ...
            modelBuilder.Entity("Sol_server_api.Entities.Admin", b =>
                {
                    b.HasOne("Sol_server_api.Entities.PersonalData", "PersonalData")
                        .WithMany()
                        .HasForeignKey("PersonalDataTelNumber");
