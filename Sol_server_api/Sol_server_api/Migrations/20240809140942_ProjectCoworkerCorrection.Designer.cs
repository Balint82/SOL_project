...
namespace Sol_server_api.Migrations
{
    ...
    [Migration("20240809140942_ProjectCoworkerCorrection")]
    partial class ProjectCoworkerCorrection
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sol_server_api.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AdminID = 1,
                            AdminName = "admin",
                            Password = "$2a$11$NYHqZb6G5q8VRyDo6.Scs.we5UfLO85sS8.vf/32S/w0xB/yL85yu",
                            RoleID = 4
                        });
                });
