...
namespace Sol_server_api.Migrations
{
    ...
    [Migration("20241017100816_ProjectPackageRealPiece")]
    partial class ProjectPackageRealPiece
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sol_server_api.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AdminID = 1,
                            AdminName = "admin",
                            Password = "$2a$11$DHO10G6lgbKMx5diewKBrePhP4lY9AU6Y5QMZHI4s6R7XWGKNHsmu",
                            RoleID = 4
                        });
                });
