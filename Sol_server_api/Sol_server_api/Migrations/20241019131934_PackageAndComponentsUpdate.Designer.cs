...
namespace Sol_server_api.Migrations
{
    ...
    [Migration("20241019131934_PackageAndComponentsUpdate")]
    partial class PackageAndComponentsUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sol_server_api.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AdminID = 1,
                            AdminName = "admin",
                            Password = "$2a$11$B3rtKMLIGSVUruUC6sIuzurWF7BFTDDOxOvnFQnUAR79dNdnOoBcq",
                            RoleID = 4
                        });
                });
